...
<template>
            ...
            <div class="flex flex-col gap-6 ">
                <div class=" font-bold flex flex-col gap-5 lg:text-6xl gap-3 md:text-5xl gap-3 xs:text-2xl ">
                    ...
                    <div class="flex flex-row items-center gap-2">
                        ...
                        <p class="font-jakarta">pour</p>
                    </div>
                    <p class="font-jakarta">l'orientation des</p>
                    <div class="flex">
                        <p class="text-orange font-shadows">jeunes</p>
                    </div>
                </div>
                <div>
    ...
    <div
        class="flex flex-col items-center font-bold justify-center mt-20 lg:text-xl sm: flex flex-row items-center justify-center ">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="bg-gray-50 rounded-xl p-6 shadow">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="font-bold">Inès</span>
                </div>
                <div class="flex gap-1 text-yellow-400 mb-2">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                </div>
                <p class="text-sm text-gray-700">
                    Grâce à Oriens, j'ai très trouvé une formation qui me correspond vraiment ! Une fiche métier très
                    nette, et des conseils de domaines que je ne connaissais pas du tout.
                </p>
            </div>
            <div class="bg-gray-50 rounded-xl p-6 shadow">
                <div class="flex items-center gap-2 mb-2">
                    <img src="../images/avatar2.png" alt="avatar" class="w-8 h-8 rounded-full" />
                    <span class="font-bold">Julien T.</span>
                </div>
                <div class="flex gap-1 text-yellow-400 mb-2">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                </div>
                <p class="text-sm text-gray-700">
                    Je ne pensais pas être réorienté complètement, mais grâce à ma première séance d'accompagnement, mon
                    choix s'est affiné et j'ai pu rencontrer les bonnes écoles et pros.
                </p>
            </div>
            <div class="bg-gray-50 rounded-xl p-6 shadow">
                <div class="flex items-center gap-2 mb-2">
                    <img src="../images/avatar3.png" alt="avatar" class="w-8 h-8 rounded-full" />
                    <span class="font-bold">Samuel B.</span>
                </div>
                <div class="flex gap-1 text-yellow-400 mb-2">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                </div>
                <p class="text-sm text-gray-700">
                    Grâce à ce projet, j'ai enfin créé du sens. On apprend vraiment à mieux se connaître, et cela change
    ...
    <div class="flex flex-col md:flex-row items-center justify-between bg-orange-400 py-12 px-8 rounded-xl my-16">
        <div class="flex-1 text-white">
            <h2 class="text-2xl md:text-3xl font-bold mb-4">Inscrivez-vous et découvrez<br>une méthode d’orientation
    ...
    <section class="max-w-5xl mx-auto my-20">
        <h3 class="text-2xl font-bold mb-8">
            Un accompagnement <span class="text-orange-500 font-shadows">personnalisé</span>
        </h3>
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-100 rounded-xl p-6">
                <h4 class="font-bold mb-2">Est-ce que l’accès à la plateforme est gratuit ?</h4>
                <p class="text-gray-700 text-sm">
                    L’inscription et le test d’orientation de base sont gratuits et sans collecte de données. Des
                    formules premium existent pour accéder plus rapidement à des accompagnements individuels et accéder
                    à l’ensemble des ressources.
                </p>
            </div>
            <div class="bg-gray-100 rounded-xl p-6">
                <h4 class="font-bold mb-2">Puis-je télécharger ou imprimer les fiches métiers et formations ?</h4>
                <p class="text-gray-700 text-sm">
                    Oui, toutes les fiches sont disponibles en version téléchargeable (PDF), vous pouvez consulter hors
                    ligne ou imprimer selon les besoins.
                </p>
            </div>
        </div>
        <a href="#" class="block mt-4 text-sm underline text-gray-500">Voir toutes les questions</a>
    </section>
</template>
